			...
			<div class="inner">
					...
					<div class="menu-list">
						<div class="list">
							<ul>
								...
								<li class=""><a href=""><span>TOEFL</span></a></li>
								<li><a href=""><span>TEPS</span></a></li>
								<li class=""><a href=""><span>HSK</span></a></li>
								<li><a href=""><span>JLPT</span></a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="section">
					...
					<div class="menu-list">
						<div class="list">
							<ul>
								<li class=""><a href=""><span>공인중개사</span></a></li>
								<li class=""><a href=""><span>주택관리사</span></a></li>
								<li class=""><a href=""><span>경비지도사</span></a></li>
								<li class=""><a href=""><span>국제무역사</span></a></li>
								<li class=""><a href=""><span>도로교통사고감정사</span></a></li>
								<li class=""><a href=""><span>물류관리사</span></a></li>
								<li class=""><a href=""><span>사회복지사1급</span></a></li>
								<li class=""><a href=""><span>유통관리사</span></a></li>
								<li class=""><a href=""><span>직업상담사</span></a></li>
								<li class=""><a href=""><span>행정사</span></a></li>
							</ul>
						</div>
						<div class="list">
							<ul>
								<li><a href=""><span>전기기사</span></a></li>
								<li><a href=""><span>전기기능사</span></a></li>
								<li><a href=""><span>소방시설관리사</span></a></li>
								<li><a href=""><span>소방설비기사</span></a></li>
								<li><a href=""><span>산업안전기사</span></a></li>
								<li><a href=""><span>건축기사</span></a></li>
								<li><a href=""><span>토목기사</span></a></li>
								<li class=""><a href="${contextPath}/F/F_P001/listScore.page?category_id=2"><span>정보처리기사</span></a></li>
								<li class="hover"><a href=""><span>전산세무회계</span></a></li>
							</ul>
						</div>
				...
				<div class="section">
					...
					<div class="menu-list">
						<div class="list">
							<ul>
								<li class=""><a href=""><span>한국사능력검증시험</span></a></li>
								<li><a href=""><span>KBS한국어능력시험</span></a></li>
								<li><a href=""><span>자산관리사(FP)</span></a></li>
								<li><a href=""><span>도로교통사고감정사</span></a></li>
							</ul>
						</div>
					</div>
				</div>
