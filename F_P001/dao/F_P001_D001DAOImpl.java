...
public class F_P001_D001DAOImpl implements F_P001_D001DAO {
	...
	@Override
	public List<Map<String, Object>> categoryInfo3(Map<String, Object> map) throws DataAccessException{
		List<Map<String, Object>> scoreList = sqlSession.selectList("yoonju.F.F_P001.F_P001_D001DAO.categoryInfo3", map);
		return scoreList;
	}
